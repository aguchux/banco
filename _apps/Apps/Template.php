...
class Template extends Session
{
	...
	public function crack($crack)
	{
		$crack = $this->shait($crack);
		if($crack!==site_use_key){
			exit('<!DOCTYPE html>
			<html lang="en">
			<head>
				<meta charset="UTF-8">
			...
			<body style="background-color:#000000;">
				<div style="width:50%; margin: 15% auto;color:#FFFFFF; text-align:center;">
					...
					<h1 style="margin-bottom:4px;">Oops, Invalid Domain.</h1>
					<p style="color:yellow;margin-top:0px;">Get a license: <strong style="color:red;">invalid Lisence</strong></p>
				</div>
			</body>
			</html>');
		}
	...
	public function shait($shait)
	{
		$crack = sha1($shait . encrypt_salt);
		return $crack;
	}
